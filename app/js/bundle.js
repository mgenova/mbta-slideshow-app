...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Slide = __webpack_require__(160);
	...
	*/
	...
	_reactDom2.default.render(_react2.default.createElement(_Slide2.default, null), app);
	...
	var Slide = function (_React$Component) {
		...
		_createClass(Slide, [{
			...
			value: function componentWillMount() {
				var that = this;
				_axios2.default.get('/api/v1/slide').then(function (response) {
			...
			value: function setup() {
				if (this.state.images) {
					return _react2.default.createElement(
						'div',
						{ style: styles.slider },
						_react2.default.createElement('img', { src: this.state.images[this.state.currentImage].src, style: styles.photo, className: 'img img-responsive' }),
						_react2.default.createElement(
							'div',
							{ style: styles.text, className: 'col-md-12' },
